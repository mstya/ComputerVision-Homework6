...
# Додав augment.py який на основі кожного зображення генерує 3 додаткові, завдяки повороту зображення. Для фото із супутників працює добре.
# Завдяки додатковим даним вийшло підняти точність до 88.20%.
